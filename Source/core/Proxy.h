...
namespace Core {
    ...
    private:
        ...
        void RemoveElement(const ContainerElement* element) const
        {
            _lock.Lock();
    ...
    public:
        ...
        Core::ProxyType<PROXYELEMENT> Instance(Args&&... args)
        {
            ...
            ContainerElement* newItem(new (0) ContainerElement<PROXYELEMENT, REALTYPE>(*this, std::forward<Args>(args)...));
